...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="view-appointments-approved.php?delid=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Yes</a>
      <a href="view-appointments-approved.php" class="button button--error" data-for="js_success-popup">No</a>
    </p>
  </div>
</div>
<?php } ?>
...
<?php
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
          ...
          if($rs['status'] != "Approved")
          {
            if(!(isset($_SESSION['patientid'])))
            {
              echo "<a href='view-appointments-approved.php?approveid=$rs[appointmentid]&patientid=$rs[patientid]' class='btn btn-xs btn-primary'>Approve</a>";
            }
            echo "  <a href='view-appointments-approved.php?id=$rs[appointmentid]' class='btn btn-xs btn-danger'>Delete</a>";
          }
          else
          {
