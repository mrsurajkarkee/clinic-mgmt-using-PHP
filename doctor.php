...
?>
  ...
  <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="text" name="department" id="consultancy_charge" value="<?php if(isset($_GET['editid'])) { echo $rsedit['department']; } ?>"/>
        </div>
...
<?php } ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="text" name="experience" id="experience" value="<?php
             if(isset($_GET['editid'])) { echo $rsedit['experience']; } ?>"/>
        </div>
